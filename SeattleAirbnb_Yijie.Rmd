...
```{r}
setwd("/Users/yijiewu/Desktop/STAT 504/Project")
...
```
```{r}
df$review_scores_rating[ 0 <= df$review_scores_rating && df$review_scores_rating<= 87] <- "bad"
df$review_scores_rating[ 87 < df$review_scores_rating && df$review_scores_rating<= 95] <- "fair"
df$review_scores_rating[ 95 < df$review_scores_rating && df$review_scores_rating<= 98]  <- "good"
df$review_scores_rating[ 98 < df$review_scores_rating && df$review_scores_rating<= 100]  <- "excellent"
table(df$review_scores_rating)
```
