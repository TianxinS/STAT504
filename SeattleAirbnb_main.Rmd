...
#setwd("C:/Users/Peter Liu/Desktop/STAT423/Project/STAT504_Final_Project") #Seraphina
setwd(".")  #Tianxin
>>>>>>> 3a9f99cea5e69819f2f4dddc352315f52c37e9ab
...
plot(df$cancellation_policy,main="cancellation policy")
plot(df$Pets_Allowed,main="Pets Allowed")
plot(df$property_type,main="Property Type")
plot(df$instant_bookable,main="Instant Bookable")
```
...
```{r}
model = lm(price~ host_response_rate + neighbourhood_cleansed + property_type+ room_type+accommodates+availability_365+review_scores_rating+reviews_per_month+ instant_bookable+cancellation_policy+minimum_nights+parking+washer+checkin24+Pets_Allowed+review_rating, data = df)
