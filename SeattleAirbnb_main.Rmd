...
```{r}
fit1 = lm(price ~  host_response_rate + neighbourhood_cleansed + room_type+accommodates + availability_365 + review_scores_rating+ reviews_per_month+ instant_bookable + cancellation_policy + minimum_nights + parking + washer + checkin24 + Pets_Allowed + review_rating, data=df)
summary(fit1)
```
